  ...
  <div class="mt-8 pt-8 flex flex-row border-t border-gray-200 max-w-xs mx-auto justify-end">
      ...
      <div class="my-5 ml-3">
        <div class="flex-col pb-5">
            <p id="contact" class="text-xs mb-2 text-red-500 mb-10">首都圏を中心に賃貸物件、売買物件の仲介もしております。お手伝いできると思いますので、お気軽に <a href="https://xbatonx.com" target='_blank' class="text-gray-400 hover:text-gray-600 underline">こちらのサイト </a>よりご連絡ください。</p>
