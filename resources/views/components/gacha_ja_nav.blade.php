              ...
              <div class=" flex items-center">
                  ...
                  <div class="hidden md:block">
                      <div class="ml-10 flex items-baseline space-x-4">
                          ...
                          <a class=" dark:text-white  hover:text-gray-800 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium underline" href="https://sojusoju.coffee" target="_blank">俺の飲んだもの</a>
